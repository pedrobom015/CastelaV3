-- -----------------------------------------------------------------------------
-- PARTE 10: SERVI\x80OS E ATENDIMENTOS
-- -----------------------------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS membership_card(
    ...
    beneficiary_id INT UNSIGNED,
    card_cod VARCHAR(100) COMMENT 'C\xa2digo impresso no cart?o',
    vencimento VARCHAR(100) COMMENT 'V\xa0lido at\x82...',
    observacao TEXT,
    ...
    entregue_at TIMESTAMP NULL COMMENT 'Data da entrega ao benefici\xa0rio',
    valor DECIMAL(19,4) COMMENT 'Valor (quando cobrado)',
    pago_at TIMESTAMP NULL COMMENT 'Data do pagamento',
    numop VARCHAR(10) COMMENT 'N\xa3mero do caixa',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP NULL DEFAULT NULL,
    created_by INT UNSIGNED,
