...
-- Vers?o: 2.0.1
-- Data: 2026-01-13
-- Descri\x87?o: Schema completo compat\xa1vel com MySQL 8.0+
...
-- -----------------------------------------------------------------------------
-- PARTE 2: TABELAS BASE (sem depend\x88ncias)
-- -----------------------------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS document_type(
    ...
    name VARCHAR(50), -- CPF, RG, CNH, Passaporte, Carteirinha, Correspond\x88ncia, Carn\x88
