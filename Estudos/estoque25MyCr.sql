...
CREATE TABLE IF NOT EXISTS product_pricing (
    ...
    sys_user_id INT UNSIGNED NOT NULL,
    product_id INT UNSIGNED NOT NULL,
    variation_id INT UNSIGNED NULL, -- NULL for base product pricing
...
CREATE TABLE IF NOT EXISTS product_image (
    ...
    sys_user_id INT UNSIGNED NOT NULL,
    product_id INT UNSIGNED NOT NULL,
    variation_id INT UNSIGNED NULL, -- NULL for general product images
...
CREATE TABLE IF NOT EXISTS product_supplier (
    ...
    sys_user_id INT UNSIGNED NOT NULL,
    product_id INT UNSIGNED NOT NULL,
    variation_id INT UNSIGNED NULL, -- NULL for base product
...
CREATE TABLE IF NOT EXISTS stock_level (
    ...
    warehouse_id INT UNSIGNED NOT NULL,
    location_id INT UNSIGNED NULL COMMENT 'NULL for unlocated stock', -- Explicitly NULL
...
CREATE TABLE IF NOT EXISTS goods_receipt (
    ...
    warehouse_id INT UNSIGNED NOT NULL,
    received_by INT UNSIGNED NULL, -- Should reference sys_user(sys_user_id)
...
CREATE TABLE IF NOT EXISTS supplier_return (
    ...
    notes TEXT,
    approved_by INT UNSIGNED NULL, -- Should reference sys_user(sys_user_id)
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP NULL DEFAULT NULL,
    created_by INT UNSIGNED,
...
CREATE TABLE IF NOT EXISTS sales_allocation (
    ...
    allocated_by INT UNSIGNED NULL, -- Should reference sys_user(sys_user_id)
    is_active BOOLEAN DEFAULT TRUE,
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS shipment (
    ...
    shipped_by INT UNSIGNED NULL, -- Should reference sys_user(sys_user_id)
    status VARCHAR(20) DEFAULT 'DRAFT' CHECK (status IN ('DRAFT', 'PICKING', 'PACKED', 'SHIPPED', 'DELIVERED', 'CANCELLED')),
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP NULL DEFAULT NULL,
    created_by INT UNSIGNED NULL, -- Should reference sys_user(sys_user_id)
    updated_by INT UNSIGNED NULL,
    deleted_by INT UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS audit_log (
    ...
    changed_by INT UNSIGNED NULL, -- Should reference sys_user(sys_user_id)
