-- ======================================================================
-- VALIDA€?O DE CONFORMIDADE MYSQL 8
...
SELECT 
    ...
    CASE 
        WHEN REFERENCED_TABLE_NAME IS NOT NULL THEN '? FK v lida'
        ELSE '? FK quebrada'
    END AS Status_FK
...
-- Verificar tabelas com campos not null sem default (poss¡veis problemas)
SELECT 
    TABLE_NAME,
...
-- ======================================================================
-- Execute este script ap¢s criar os bancos de dados para validar
