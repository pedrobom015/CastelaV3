...
export const BeneficiaryCreate = ({ onClose }) => {
	...
	const handleSave = (values) => {
		create(
			...
			{
				onSuccess: () => {
					notify("Beneficiário criado com sucesso 🎉");
					refresh();
					onClose();
				},
				onError: () =>
					notify("Erro ao criar Beneficiário", { type: "error" }),
			},
		);
	};
...
export const BeneficiaryEdit = ({ record, onClose }) => {
	...
	const handleSave = (values) => {
		update(
			...
			{
				onSuccess: () => {
					notify("Beneficiário atualizado com sucesso ✅");
					refresh();
					onClose();
				},
				onError: () =>
					notify("Erro ao atualizar Beneficiário", { type: "error" }),
			},
		);
	};
	return (
...
export const BeneficiaryList = ({ resourceData = "beneficiary" }) => {
	...
	console.log(unitsGroup, permissionsArray, "beneficiary");
