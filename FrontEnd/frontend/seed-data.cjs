...
write('COBRADOR', CAMPOS.COBRADOR, [
  { cobrador: '001', funcao: 'C', nome: 'JOSE DA SILVA',         endereco: 'RUA DAS FLORES 123',     bairro: 'CENTRO',    cidade: 'SAO PAULO', telefone: '(11) 9999-1111', cpf: '11122233344', percent: 10.0, superv: '' },
  ...
  { cobrador: '003', funcao: 'C', nome: 'PEDRO HENRIQUE SOUZA',  endereco: 'RUA DO COMERCIO 789',    bairro: 'NORTE',     cidade: 'SAO PAULO', telefone: '(11) 9999-3333', cpf: '33344455566', percent: 10.0, superv: '001' },
...
write('GRUPOS', CAMPOS.GRUPOS, [
  {
    codigo: '000000001', grupo: '01', situacao: '1',
    nome: 'JOAO DA SILVA',
  ...
  {
    codigo: '000000002', grupo: '01', situacao: '1',
  ...
  {
    codigo: '000000003', grupo: '02', situacao: '1',
  ...
  {
    codigo: '000000004', grupo: '01', situacao: '1',
  ...
  {
    codigo: '000000005', grupo: '01', situacao: '1',
  ...
  {
    codigo: '000000006', grupo: '03', situacao: '1',
  ...
  {
    codigo: '000000007', grupo: '02', situacao: '1',
  ...
  {
    codigo: '000000008', grupo: '01', situacao: '2',  // cancelado
  ...
  {
    codigo: '000000009', grupo: '01', situacao: '1',
  ...
  {
    codigo: '000000010', grupo: '01', situacao: '1',
...
// Só gera taxa para contratos ATIVOS (situacao='1') com carência vencida
...
// 000001 → 2 pendentes (fev + mar)
// 000002 → 3 pendentes (jan + fev + mar) — máximo atraso
// 000005 → 2 pendentes (fev + mar)
...
// ─── PRADENDO (produtos/serviços disponíveis como adendo) ────────────────────
const CAMPOS_PRADENDO = [
...
write('PRADENDO', CAMPOS.PRADENDO, [
  { codigo: '0001', produto: 'URNA EXECUTIVA MOGNO',       unid: 'UN', grupo: 'URNAS',    depto: 'FUNERARIO', qd_min: 1, qd_est: 10, preco_cus: 1800.00, preco_ven: 2800.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0002', produto: 'URNA STANDARD PINUS',        unid: 'UN', grupo: 'URNAS',    depto: 'FUNERARIO', qd_min: 2, qd_est: 20, preco_cus:  800.00, preco_ven: 1400.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0003', produto: 'ORNAMENTACAO FLORAL BASICA', unid: 'SV', grupo: 'FLORES',   depto: 'CERIMONIAL', qd_min: 0, qd_est: 99, preco_cus:  150.00, preco_ven:  350.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0004', produto: 'ORNAMENTACAO FLORAL PREMIUM',unid: 'SV', grupo: 'FLORES',   depto: 'CERIMONIAL', qd_min: 0, qd_est: 99, preco_cus:  400.00, preco_ven:  900.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0005', produto: 'TRANSLADO LOCAL (ATÉ 50KM)', unid: 'SV', grupo: 'TRANSL',   depto: 'LOGISTICA',  qd_min: 0, qd_est: 99, preco_cus:  200.00, preco_ven:  450.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0006', produto: 'TRANSLADO INTERESTADUAL',    unid: 'SV', grupo: 'TRANSL',   depto: 'LOGISTICA',  qd_min: 0, qd_est: 99, preco_cus:  900.00, preco_ven: 2200.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0007', produto: 'CREMACAO COMPLETA',          unid: 'SV', grupo: 'CREMACAO', depto: 'FUNERARIO', qd_min: 0, qd_est: 99, preco_cus: 1200.00, preco_ven: 2500.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0008', produto: 'VELORIO EM SALA VIP',        unid: 'SV', grupo: 'VELORIO',  depto: 'CERIMONIAL', qd_min: 0, qd_est: 99, preco_cus:  500.00, preco_ven: 1200.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0009', produto: 'CARPA COBERTURA EXTERNA',    unid: 'SV', grupo: 'EQUIP',    depto: 'CERIMONIAL', qd_min: 0, qd_est: 10, preco_cus:  100.00, preco_ven:  250.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0010', produto: 'JAZIGO PERPETUO CEMITERIO',  unid: 'UN', grupo: 'JAZIGO',   depto: 'CEMITERIO',  qd_min: 0, qd_est:  5, preco_cus: 4000.00, preco_ven: 8500.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0011', produto: 'MISSA DE SETIMO DIA',        unid: 'SV', grupo: 'RELIGIOSO',depto: 'CERIMONIAL', qd_min: 0, qd_est: 99, preco_cus:   80.00, preco_ven:  180.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
  { codigo: '0012', produto: 'CERIMONIAL COMPLETO PREMIUM',unid: 'SV', grupo: 'CERIM',    depto: 'CERIMONIAL', qd_min: 0, qd_est: 99, preco_cus: 2500.00, preco_ven: 5500.00, venda_: new Date('2025-01-01'), dt_ult_atu: new Date('2025-01-01') },
])

// ─── ADENDOS (adendos vinculados a contratos) ─────────────────────────────────
const CAMPOS_ADENDOS = [
...
write('ADENDOS', CAMPOS.ADENDOS, [
  // Contrato 000001 — 2 adendos
  { codigo: '000000001', codproduto: '0005', incluido_: new Date('2024-03-10'), idxd: '', idxm: '', flag_excl: ' ' },
  { codigo: '000000001', codproduto: '0009', incluido_: new Date('2024-03-10'), idxd: '', idxm: '', flag_excl: ' ' },
  // Contrato 000002 — urna premium + cremação
  { codigo: '000000002', codproduto: '0001', incluido_: new Date('2024-05-20'), idxd: '', idxm: '', flag_excl: ' ' },
  { codigo: '000000002', codproduto: '0007', incluido_: new Date('2024-05-20'), idxd: '', idxm: '', flag_excl: ' ' },
  // Contrato 000003 — jazigo
  { codigo: '000000003', codproduto: '0010', incluido_: new Date('2023-11-01'), idxd: '', idxm: '', flag_excl: ' ' },
  // Contrato 000004 — floral premium
  { codigo: '000000004', codproduto: '0004', incluido_: new Date('2024-01-15'), idxd: '', idxm: '', flag_excl: ' ' },
  // Contrato 000005 — cerimonial completo
  { codigo: '000000005', codproduto: '0012', incluido_: new Date('2024-06-01'), idxd: '', idxm: '', flag_excl: ' ' },
  { codigo: '000000005', codproduto: '0011', incluido_: new Date('2024-06-01'), idxd: '', idxm: '', flag_excl: ' ' },
  // Adendo excluído (exemplo de flag_excl='*')
  { codigo: '000000001', codproduto: '0003', incluido_: new Date('2024-01-01'), idxd: '', idxm: '', flag_excl: '*' },
])
