	...
	this.initResourceFilter = function () {
		...
		groupDiv.tree({
			...
			onCreateLi: function (node, $li) {
				...
				var label = $('<label hidden><input type="checkbox" name="resourceId[]"/> ' + itemName + '</label>');
				var label_group = $('<label><input type="checkbox" name="groupId[]"/> ' + itemName + '</label>');
