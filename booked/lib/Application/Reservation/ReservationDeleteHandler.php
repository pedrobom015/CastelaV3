...
interface IReservationDeleteHandler
{
	/**
	 ...
	 */
	public function HandleExisting(ExistingReservationSeries $reservationSeries, IReservationSaveResultsView $view);
}

class ReservationDeleteHandler implements IReservationDeleteHandler
{
	/**
	...
	public static function Create($reservationAction, $persistenceService, UserSession $session)
	{
		...
		return new ReservationDeleteHandler($persistenceService, $validationService, $notificationService);
	}
