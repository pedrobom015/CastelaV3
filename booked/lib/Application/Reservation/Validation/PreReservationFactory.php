...
class PreReservationFactory implements IPreReservationFactory
{
	...
	public function CreatePreAddService(UserSession $userSession)
	{
		Log::Debug('SPM! CreatePreAddService!');
	...
	public function CreatePreUpdateService(UserSession $userSession)
	{
		Log::Debug('SPM! CreatePreUpdateService!');
	...
	public function CreatePreDeleteService(UserSession $userSession)
	{
		Log::Debug('SPM! CreatePreDeleteService!');
	...
	public function CreatePreApprovalService(UserSession $userSession)
	{
		Log::Debug('SPM! CreatePreApprovalService!');
	...
	public function CreatePreCheckinService(UserSession $userSession)
	{
		Log::Debug('SPM! CreatePreCheckinService!');
		$rules = array();
	...
	public function CreatePreCheckoutService(UserSession $userSession)
	{
		Log::Debug('SPM! CreatePreCheckoutService!');
		$rules = array();
	...
	{
		Log::Debug('SPM! CreateAddService!');
	...
	{
		Log::Debug('SPM! CreateUpdateService!');
	...
	{
		Log::Debug('SPM! CreateDeleteService!');
	...
	{
		Log::Debug('SPM! GetRuleProcessor!');
		// Common rules
		$rules = array();
		...
		/*SANTOSM START*/
		$rules[] = new AdminExcludedRule(new ProductorValidationRule($this->userRepository), $userSession, $this->userRepository);
		/*SANTOSM END*/
	...
	{
		Log::Debug('SPM! GetAddUpdateRuleProcessor!');
