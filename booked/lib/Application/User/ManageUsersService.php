...
interface IManageUsersService
{
	 ...
	 * @return User
	 */
	/*santosm*/public function UpdateUser($userId, $username, $email, $firstName, $lastName, $timezone, $validityStart, $validityEnd, $extraAttributes);
     ...
     */
	public function SaveOrUpdateProductor($niu, $validityStart, $validityEnd); //santosm
}
...
class ManageUsersService implements IManageUsersService
{
	...
	/*santosm*/public function UpdateUser($userId, $username, $email, $firstName, $lastName, $timezone, $validityStart, $validityEnd, $extraAttributes)
	{
		...
		$user->ChangeValidity($validityStart, $validityEnd);//santosm
