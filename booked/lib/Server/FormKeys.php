...
class FormKeys
{
  ...
  const STRIPE_ENABLED = 'ENABLE_STRIPE';
	...
	const SANCTION_START = 'SANCTION_START';//santosm
	const SANCTION_END = 'SANCTION_END';//santosm
	
	const VALIDITY_START = 'VALIDITY_START';//santosm
	const VALIDITY_END = 'VALIDITY_END';//santosm
	
	const NEW_VALIDITY_START = 'VALIDITY_START';//santosm
	const NEW_VALIDITY_END = 'VALIDITY_END';//santosm
	const UPDATE_PRODUCTOR_ON_IMPORT = 'UPDATE_PRODUCTOR_ON_IMPORT';//santosm
	const PRODUCTORS_LIST = 'PRODUCTORS_LIST';//santosm
