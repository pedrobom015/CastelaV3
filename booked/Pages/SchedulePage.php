...
class SchedulePage extends ActionPage implements ISchedulePage
{
    ...
    public function __construct()
    {
        ...
        /*SANTOSM START*/
        //$userRepository = new UserRepository();
        $this->_presenter = new SchedulePresenter($this, $scheduleService, $resourceService, $pageBuilder, $reservationService /*, $userRepository*/);
        /*SANTOSM END*/
    }
     ...
     *
    public function ShowUserSanctioned($isUserSanctioned) {
        $this->Set('IsUserSanctioned', $isUserSanctioned);
    }
     ...
     *
    public function ShowUserValid($isUserValid) {
        $this->Set('IsUserValid', $isUserValid);
    }
    //SANTOSM END*/
}
