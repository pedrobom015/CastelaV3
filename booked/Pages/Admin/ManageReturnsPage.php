...
require_once(ROOT_DIR . 'Presenters/Admin/ManageReturnsPresenter.php');

interface IManageReturnsPage extends IPageable, IActionPage
{
    /**
...
class ManageReturnsPage extends ActionPage implements IManageReturnsPage
{
    /**
     * @var ManageReturnsPresenter
     */
    protected $presenter;
    ...
    {
        parent::__construct('ManageReturns', 1);

        $this->presenter = new ManageReturnsPresenter($this,
    ...
    public function ShowPage()
    {
        $this->Display('Admin/Reservations/manage_returns.tpl');
    }
