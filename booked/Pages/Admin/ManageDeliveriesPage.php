...
require_once(ROOT_DIR . 'Presenters/Admin/ManageDeliveriesPresenter.php');

interface IManageDeliveriesPage extends IPageable, IActionPage
{
    /**
...
class ManageDeliveriesPage extends ActionPage implements IManageDeliveriesPage
{
    /**
     * @var ManageDeliveriesPresenter
     */
    protected $presenter;
    ...
    {
        parent::__construct('ManageDeliveries', 1);

        $this->presenter = new ManageDeliveriesPresenter($this,
    ...
    public function ShowPage()
    {
        $this->Display('Admin/Reservations/manage_deliveries.tpl');
    }
