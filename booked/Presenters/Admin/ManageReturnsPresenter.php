...
require_once(ROOT_DIR . 'Pages/Admin/ManageReturnsPage.php');
...
class ManageReturnsPresenter extends ActionPresenter
{
    /**
    ...
    public function PageLoad($userTimezone)
    {
        ...
        if (!$this->page->FilterButtonPressed()) {
            ...
            */
            ...
            $filters = array();
            $filters[5] = $filterPreferences->GetFilterUserId();  //Filter authorized NIUs
            /*
    ...
    private function GetDate($dateString, $timezone, $defaultDays)
    {
        ...
        if (is_null($dateString)) {
            $date = Date::Now()->ToTimezone($timezone)->GetDate();
        }
