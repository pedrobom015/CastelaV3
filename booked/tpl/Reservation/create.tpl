    ...
    <div id="reservation-box">
        <form id="form-reservation" method="post" enctype="multipart/form-data" role="form">
            ...
            <div class="row col-xs-12" id="termsAndConditions">
                <div class="col-xs-12">
                    <div class="checkbox">
                        <input type="checkbox" id="termsAndConditionsAcknowledgement" {formname key=TOS_ACKNOWLEDGEMENT} disabled="disabled"/>
                        <label for="termsAndConditionsAcknowledgement">{translate key=IAccept}</label>
                        <a href="{$Terms->DisplayUrl()}" onclick="$('#termsAndConditionsAcknowledgement')[0].disabled=false" style="vertical-align: middle" target="_blank">{translate key=TheTermsOfService}</a>
                    </div>
                </div>
            </div>
            {else}
            <div class="col-xs-12">
                <div class="checkbox">
                    <input type="checkbox" id="termsAndConditionsAcknowledgement" {formname key=TOS_ACKNOWLEDGEMENT} checked/>
                    <label for="termsAndConditionsAcknowledgement">{translate key=IAccept}</label>
                </div>
            </div>
            {/if}
